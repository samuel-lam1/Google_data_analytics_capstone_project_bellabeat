...
* From the chart, generally if the users need to burn 10 calories in a minute, on average they need to perform exercises which can keep the heart rate at around 145 for 1 minute.
<br>
